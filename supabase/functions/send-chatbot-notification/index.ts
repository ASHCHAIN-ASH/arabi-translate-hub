...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    const emailResponse = await resend.emails.send({
      from: "فكرة إيدو <onboarding@resend.dev>",
      to: ["info@fekrahtech.com"], // إيميل المطور للاختبار
      subject: "🤖 رسالة جديدة من الشات بوت - وكالة فكرة إيدو",
      html: `
        <!DOCTYPE html>
            ...
            <div class="content">
              ...
              <div style="background: #fef3c7; border: 1px solid #fbbf24; border-radius: 8px; padding: 15px; margin: 20px 0;">
                ...
                <p style="margin: 5px 0 0 0; color: #92400e; font-size: 14px;">
                  هذه الرسالة تم إرسالها تلقائياً من الشات بوت الذكي في موقع وكالة فكرة إيدو. 
