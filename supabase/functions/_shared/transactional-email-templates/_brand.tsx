...
export const S = {
  ...
  tdValue: { padding: '10px 12px', fontSize: '13px', color: '#0f172a', textAlign: 'left' as const, borderBottom: '1px solid #e2e8f0', fontWeight: '700' as const },
}

export const heroBox = (a: Accent = 'blue') => ({
  margin: '22px 28px', padding: '22px', backgroundColor: accentOf(a).soft,
  border: `2px solid ${accentOf(a).solid}22`, borderRadius: '14px', textAlign: 'center' as const,
})
...
export const card = { margin: '16px 28px', padding: '18px', backgroundColor: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: '12px' }
