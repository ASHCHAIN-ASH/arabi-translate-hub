...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    const { name, email, phone, subject, message, serviceType }: ContactMessageRequest = await req.json();
          ...
          <div class="container">
            ...
            <div class="content">
              ...
              <div className="info-row">
                ...
                <span class="value">0559600824 (أساسي) | 0559600824 (ثانوي)</span>
              </div>
          ...
          <div class="container">
            ...
            <div class="content">
              ...
              <div class="contact-info">
                ...
                <p>📞 الهاتف الأساسي: 0559600824</p>
                <p>📞 الهاتف الثانوي: 0559600824</p>
                <p>💬 الواتساب الأساسي: 0559600824</p>
