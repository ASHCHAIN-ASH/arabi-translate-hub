...
SELECT * FROM (VALUES
  ('شكر واستلام',  E'مرحباً،\n\nشكراً لتواصلك مع وكالة فكرة إيدو. وصلتنا رسالتك وسنعود إليك في أقرب وقت ممكن خلال ساعات العمل.\n\nمع تحياتنا,\nفريق فكرة إيدو', 'عام',     'ack'),
  ('طلب تفاصيل',  E'مرحباً،\n\nنشكرك على اهتمامك بخدماتنا. لنتمكن من خدمتك بدقة، نرجو تزويدنا بالتفاصيل التالية:\n• المرحلة الأكاديمية والتخصص\n• الموعد المستهدف للتسليم\n• أي ملفات أو متطلبات إضافية\n\nمع التحية,\nفريق فكرة إيدو', 'استفسار', 'info'),
  ('عرض سعر',     E'مرحباً،\n\nبناءً على تفاصيل طلبك، يسعدنا تقديم العرض التالي. فريقنا متاح للإجابة عن أي استفسار وتعديل الخطة بما يناسب احتياجك.\n\nمع التحية,\nفريق فكرة إيدو', 'مبيعات', 'quote'),
  ('إغلاق وشكر', E'مرحباً،\n\nشكراً لتعاملك معنا. نأمل أن تكون تجربتك مع فكرة إيدو قد لبّت توقعاتك. لا تتردد في التواصل معنا في أي وقت.\n\nمع التحية,\nفريق فكرة إيدو', 'إغلاق',  'close')
