-- إصلاح المشاكل الأمنية في النظام

-- إنشاء سياسات RLS لجدول service_categories
...
-- الحصول على tenant_id وإنشاء البيانات الأساسية
DO $$
DECLARE
...
BEGIN
    ...
    (
        'site_name',
        '"FekrahEdu - المسار التعليمي المتميز"'::jsonb,
        'اسم الموقع الكامل',
        'general',
        fekrahedu_tenant_id
    ),
