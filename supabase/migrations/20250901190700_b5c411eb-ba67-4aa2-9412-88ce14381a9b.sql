...
'["invoice_number", "company_name", "company_address", "customer_name", "customer_email", "customer_phone", "invoice_date", "due_date", "service_name", "service_description", "total_amount", "currency", "payment_url", "support_email", "support_phone"]'::jsonb, true),
...
'["reminder_title", "urgency_level", "reminder_message", "days_left", "hours_left", "minutes_left", "progress_percentage", "action_url", "snooze_url", "helpful_tip", "company_name", "support_contact"]'::jsonb, true),
...
'["achievement_title", "customer_name", "achievement_description", "achievement_details", "total_points", "level_reached", "completion_rate", "reward_description", "claim_reward_url", "linkedin_share_url", "twitter_share_url", "facebook_share_url", "company_name"]'::jsonb, true);