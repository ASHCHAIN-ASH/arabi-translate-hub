...
FROM (VALUES
  ...
  ('دليل التوثيق بأسلوب APA 7', 'القواعد الكاملة مع 50 مثالاً تطبيقياً', 'يغطي توثيق: الكتب، المقالات، المواقع، الفصول، الرسائل، المؤتمرات، المقابلات، الـ AI. محدّث 2024.', 'pdf', 'https://apastyle.apa.org/', 'منهجية', ARRAY['APA','توثيق','مراجع'], false, true, true, 3, 'فريق MasterEduPath', 'beginner', (SELECT id FROM public.library_categories WHERE slug='method-citation')),
