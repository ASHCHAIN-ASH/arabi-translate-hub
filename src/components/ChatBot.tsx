...
const WHATSAPP_NUMBERS = [
  { number: '+966593799355', label: 'الدعم الفني والاستشارات' },
  { number: '+966593799355', label: 'خدمة العملاء' },
  { number: '+966593799355', label: 'الترجمة المتخصصة' },
  { number: '+966593799355', label: 'البحث العلمي' }
];
...
const ChatBot: React.FC<ChatBotProps> = ({ className = '' }) => {
  ...
  const openWhatsApp = (number: string) => {
    const message = `السلام عليكم، أتواصل معكم من خلال موقع FekrahEdu بخصوص الخدمات المتاحة.`;
      ...
      <Card className="w-[90vw] max-w-sm sm:w-96 sm:max-w-md lg:max-w-lg h-full shadow-2xl border border-border/50 bg-background/95 backdrop-blur-sm">
        ...
        <div className="flex items-center justify-between p-4 bg-gradient-to-r from-primary to-primary/80 text-white rounded-t-lg">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-bold text-lg">مساعد FekrahEdu</h3>
