...
const ChatBot: React.FC<ChatBotProps> = ({ className = '' }) => {
  ...
  const openWhatsApp = (number: string) => {
    const message = `السلام عليكم، أتواصل معكم من خلال موقع وكالة فكرة إيدو بخصوص الخدمات المتاحة.`;
