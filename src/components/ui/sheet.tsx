...
const SheetContent = React.forwardRef<
  ...
  SheetContentProps
>(({ side = "right", className, children, disableAnimation = false, ...props }, ref) => (
  <SheetPortal>
    ...
    <SheetPrimitive.Content
      ...
      className={cn(
        sheetVariants({ side }),
        disableAnimation && "data-[state=open]:animate-none data-[state=closed]:animate-none data-[state=closed]:duration-0 data-[state=open]:duration-0",
        className
      )}
      {...props}
    >
