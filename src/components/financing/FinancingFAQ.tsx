...
const FAQS = [
  ...
  },
  {
    ...
    a: 'لا. التمويل ليس تمويلًا نقديًا — هو رصيد داخلي يُضاف إلى محفظتك داخل المنصة بعد الموافقة، ويُستخدم فقط في سداد خدمات FekrahEdu (الترجمة، النشر، تحليل البيانات، إلخ).',
  },
  {
