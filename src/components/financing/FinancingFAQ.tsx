...
const FAQS = [
  {
    ...
    a: 'لا. تمويل FekrahEdu PayLater خالٍ تمامًا من الفوائد (APR 0%). تسدد المبلغ الأصلي فقط بدون أي رسوم إضافية أو خفية. النظام متوافق مع أحكام الشريعة الإسلامية.',
  },
  {
    q: 'هل أستلم المبلغ نقدًا في حسابي البنكي؟',
    a: 'لا. التمويل ليس تمويلًا نقديًا — هو رصيد داخلي يُضاف إلى محفظتك داخل المنصة بعد الموافقة، ويُستخدم فقط في سداد خدمات منصة فكرة (الترجمة، النشر، تحليل البيانات، إلخ).',
  },
  {
