...
const ServiceSteps = () => {
  ...
  return (
    <section className="py-12 lg:py-16 bg-gradient-to-br from-background to-muted/5 relative overflow-hidden">
      {/* خلفية بسيطة */}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 relative z-10">
            {steps.map((step, index) => {
              ...
              return (
                ...
                >
                  {/* رقم المرحلة */}
                  <div className="absolute -top-3 -right-3 w-8 h-8 bg-primary rounded-full flex items-center justify-center text-white font-semibold text-sm shadow-md z-20">
                    {step.id}
                  </div>
                  ...
                  <Card className="relative overflow-hidden border border-border bg-card hover:shadow-lg transition-all duration-300 h-full">
                    ...
                    <CardContent className="p-6 relative z-10">
                      {/* الأيقونة والعنوان */}
                      <div className="mb-4">
                        <div className={`w-12 h-12 rounded-lg bg-gradient-to-br ${step.color} flex items-center justify-center shadow-sm mb-3 mx-auto`}>
                          <IconComponent className="h-6 w-6 text-white" />
                        </div>
                        
                        <h3 className="text-lg font-arabic-formal font-semibold text-foreground text-center mb-2">
                          {step.title}
                        </h3>
        ...
        >
          ...
          <motion.button
            className="inline-flex items-center gap-2 px-6 py-3 bg-primary text-primary-foreground rounded-lg font-medium text-sm hover:bg-primary/90 transition-colors duration-200"
