...
const AcademicStats = () => {
  ...
  return (
    <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-lime-50 via-green-50 to-emerald-50 dark:from-slate-950 dark:via-green-950 dark:to-emerald-950 relative overflow-hidden">
