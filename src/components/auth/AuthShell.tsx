      ...
      <div className="relative z-10 grid min-h-screen lg:grid-cols-2">
        ...
        >
          ...
          >
            ...
            <div>
              <h2 className="text-xl font-bold leading-tight">FekrahEdu</h2>
          ...
          >
            © {new Date().getFullYear()} FekrahEdu. جميع الحقوق محفوظة.
          </motion.div>
        </aside>
          ...
          >
            ...
            <div className="lg:hidden text-center mb-6">
              <div className="inline-flex items-center gap-2 rounded-full bg-card border border-border px-3 py-1.5 shadow-sm">
                ...
                <span className="text-xs font-semibold text-foreground">FekrahEdu</span>
              </div>
            </div>
