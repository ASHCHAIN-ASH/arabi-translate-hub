...
const ACK_CARDS: AckCardConfig[] = [
  ...
  },
  {
    ...
    clauses: [
      ...
      { id: 'e6', critical: true, text: 'أُقرّ بعلمي وموافقتي على أنه سيتم خلال 24 إلى 48 ساعة من اعتماد الطلب إصدار «سند تنفيذي» رسمي وإرساله إليّ إلكترونياً للتوقيع، ويُعدّ توقيعي عليه إقراراً نهائياً ملزماً وفق نظام التنفيذ السعودي (م/53).' },
    ],
  },
];
