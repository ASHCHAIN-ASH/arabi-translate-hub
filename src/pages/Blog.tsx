...
const Blog = () => {
  const blogPosts = [
    ...
    {
      id: 4,
      title: "قصة نجاح: كيف ساعدنا شركة عالمية في توطين منتجاتها",
      excerpt: "تعرف على قصة نجاح حقيقية لشركة تقنية عالمية وكيف ساعدناها في دخول السوق العربية",
      author: "فريق MasterEduPath",
      date: "2024-01-08",
      category: "قصص النجاح",
      readTime: "5 دقائق",
      image: "/api/placeholder/800/400",
      tags: ["نجاح", "توطين", "شراكة"],
      views: 789,
      likes: 45
    },
    {
