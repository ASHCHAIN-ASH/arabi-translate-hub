      ...
      <section className="relative min-h-screen lg:min-h-[100vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          ...
          >
            ...
            >
              وكالة الحلول التعليمية المتقدمة الرائدة في المملكة. نقدم خدمات تعليمية متطورة 
              للطلاب والجامعيين والموظفين بتقنيات الذكاء الاصطناعي وفريق من الخبراء التعليميين المعتمدين.
              <br className="hidden sm:block" />
              <span className="text-white/80 text-sm sm:text-base lg:text-lg block sm:inline mt-2 sm:mt-0">
                تطوير مهني شامل • تدريب متخصص • استشارات أكاديمية • خدمة 24/7
              </span>
            </motion.p>
