...
const MedicalResearch = () => {
  const specializations = medicalSpecializations.map(s => s.title);
  const researchTypes = ['بحث طبي', 'دراسة سريرية', 'رسالة ماجستير', 'أطروحة دكتوراه', 'تقرير طبي'];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background via-pink-50/20 to-background">
      ...
      {/* Order Form Section */}
      <section id="order-form" className="py-20 bg-gradient-to-br from-gray-50 to-pink-50 dark:from-gray-900 dark:to-pink-950">
