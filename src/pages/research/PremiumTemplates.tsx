              ...
              {[
                ...
                >
                  <Card className="p-4 md:p-6 h-full border-0 shadow-lg hover:shadow-xl transition-all bg-card/80 backdrop-blur-sm">
                    <feature.icon className="w-10 h-10 md:w-12 md:h-12 text-amber-600 mb-3 md:mb-4" />
      ...
      <section className="py-12 md:py-16">
        <div className="container px-4 mx-auto">
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className="max-w-4xl mx-auto mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-center mb-8 md:mb-12">كيف نقدم لك القوالب؟</h2>
            
            <div className="space-y-4 md:space-y-6">
              {[
                { step: '1', title: 'تحديد احتياجك', description: 'نتعرف على نوع القالب المطلوب والغرض منه' },
                { step: '2', title: 'اختيار التصميم', description: 'نقترح تصاميم متنوعة تناسب احتياجك' },
                { step: '3', title: 'التخصيص', description: 'نخصص القالب بالمحتوى والألوان المطلوبة' },
                { step: '4', title: 'التسليم', description: 'نسلمك القالب جاهزاً للاستخدام الفوري' }
              ].map((step, index) => (
                <motion.div
                  key={index}
                ...
                >
                  <div className="flex-shrink-0 w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-yellow-500 to-amber-500 rounded-full flex items-center justify-center text-white font-bold text-lg md:text-xl shadow-lg">
                    {step.step}
                  </div>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
              <Card className="p-6 md:p-8 shadow-xl">
                ...
                <p className="text-center text-muted-foreground mb-6 text-sm md:text-base">
                  املأ النموذج وسنتواصل معك عبر الواتساب لتوفير القالب المطلوب
                </p>
