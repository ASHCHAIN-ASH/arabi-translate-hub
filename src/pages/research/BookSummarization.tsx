...
import { BookOpen, CheckCircle, ArrowRight, FileText, Users, Award, Clock, MessageSquare } from 'lucide-react';
        ...
        <div className="container relative z-10 px-4 mx-auto">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              تلخيص احترافي ودقيق للكتب والمراجع العلمية بأسلوب أكاديمي متميز
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-muted/30">
        <div className="container px-4 mx-auto">
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className="max-w-6xl mx-auto">
            <h2 className="text-3xl font-bold text-center mb-12">ما نقدمه في خدمة التلخيص</h2>
            
            <div className="grid md:grid-cols-3 gap-6">
              {[
                { icon: FileText, title: 'تلخيص شامل', description: 'تلخيص دقيق يغطي جميع النقاط الرئيسية' },
                { icon: Users, title: 'خبراء متخصصون', description: 'فريق من المتخصصين في مختلف المجالات' },
                { icon: Award, title: 'جودة عالية', description: 'تلخيص احترافي وفق المعايير الأكاديمية' },
                { icon: Clock, title: 'سرعة في التنفيذ', description: 'التزام بالمواعيد المحددة' },
                { icon: CheckCircle, title: 'مراجعة دقيقة', description: 'مراجعة شاملة قبل التسليم' },
                { icon: MessageSquare, title: 'دعم مستمر', description: 'متابعة ودعم على مدار الساعة' }
              ].map((feature, index) => (
                <motion.div
                  key={index}
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
              <Card className="p-8 shadow-xl">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    <Label htmlFor="details">تفاصيل الكتاب أو المرجع المطلوب تلخيصه *</Label>
                    <Textarea
                      id="details"
                      ...
                      rows={5}
                      className="mt-2"
                      placeholder="يرجى ذكر اسم الكتاب، المؤلف، عدد الصفحات، والتفاصيل الأخرى المهمة..."
                    />
                  </div>

                  <Button type="submit" disabled={loading} className="w-full bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white py-6 text-lg font-bold">
