  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-muted/20">
      ...
      <section className="relative py-20 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-teal-500/10 via-cyan-500/10 to-teal-600/10"></div>
        ...
        <div className="container relative z-10 px-4 mx-auto">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="max-w-4xl mx-auto text-center">
            <motion.div
              ...
              className="inline-flex items-center justify-center w-20 h-20 mb-6 bg-gradient-to-br from-teal-500 to-cyan-500 rounded-2xl shadow-lg"
            >
              ...
              {[
                ...
                >
                  <Card className="p-4 md:p-6 h-full border-0 shadow-lg hover:shadow-xl transition-all bg-card/80 backdrop-blur-sm">
                    <feature.icon className="w-10 h-10 md:w-12 md:h-12 text-teal-600 mb-3 md:mb-4" />
          ...
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className="max-w-4xl mx-auto mb-12">
            ...
            <div className="space-y-4 md:space-y-6">
              {[
                ...
                >
                  <div className="flex-shrink-0 w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-teal-500 to-cyan-500 rounded-full flex items-center justify-center text-white font-bold text-lg md:text-xl shadow-lg">
                    {step.step}
                  </div>
      ...
      <section className="py-12 md:py-16">
        <div className="container px-4 mx-auto">
          <div className="max-w-4xl mx-auto">
            ...
            >
              <Card className="p-6 md:p-8 shadow-2xl border-2 border-primary/20 bg-gradient-to-br from-card to-card/80 backdrop-blur-sm">
                <motion.h2 
                  initial={{ scale: 0.9, opacity: 0 }}
                  animate={{ scale: 1, opacity: 1 }}
                  transition={{ delay: 0.2 }}
                  className="text-2xl md:text-3xl font-bold mb-2 text-center bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent"
                >
                  اطلب الخدمة الآن
                </motion.h2>
                <motion.p
                ...
                <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
                  ...
                  <div>
                    <Label htmlFor="specialization">التخصص أو المادة</Label>
                    <Input
                      id="specialization"
                  ...
                  <div>
                    <Label htmlFor="details">تفاصيل الواجب أو التقرير المطلوب *</Label>
                    <Textarea
                      id="details"
