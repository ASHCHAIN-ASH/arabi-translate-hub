...
import { Users, MessageCircle, Lightbulb, Target } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative py-20 bg-gradient-primary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-arabic-title font-bold mb-6">الاستشارات الأكاديمية</h1>
          <p className="text-lg md:text-xl max-w-3xl mx-auto mb-8">استشارات متخصصة من أكاديميين ذوي خبرة</p>
