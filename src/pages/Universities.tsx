...
const Universities = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white" dir="rtl">
      ...
      {/* Publishing and Journals Section */}
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <div className="flex items-center justify-center gap-3 mb-4">
              <div className="w-12 h-12 rounded-xl flex items-center justify-center shadow-lg bg-blue-50">
                <FileText className="h-6 w-6 text-blue-600" />
              </div>
              <h2 className="text-3xl font-bold text-gray-900">النشر بالمجلات العلمية</h2>
            </div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
              دليلك الشامل للنشر في أفضل المجلات العلمية المحكمة العربية والدولية
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8">
            {[
              {
                name: "دليل المجلات العلمية المحكمة",
                nameEn: "Peer-Reviewed Journals Directory",
                icon: FileText,
                href: "/journals",
                color: "#2563EB",
                description: "دليل شامل للمجلات العلمية العربية والدولية المعتمدة للنشر الأكاديمي",
                features: ["مجلات محكمة", "فهرسة دولية", "معامل تأثير عالي", "نشر سريع"]
              },
              {
                name: "خدمات النشر العلمي",
                nameEn: "Academic Publishing Services",
                icon: BookOpen,
                href: "/research/journal-publication",
                color: "#7C3AED",
                description: "خدمات متكاملة للنشر في المجلات العلمية المحكمة مع ضمان القبول",
                features: ["استشارة مجانية", "اختيار المجلة المناسبة", "مراجعة علمية", "متابعة النشر"]
              },
              {
                name: "المجلات العربية المتخصصة",
                nameEn: "Specialized Arabic Journals",
                icon: Globe,
                href: "/journals#arabic",
                color: "#059669",
                description: "أهم المجلات العربية والإقليمية المحكمة في مختلف التخصصات العلمية",
                features: ["لغة عربية", "محكمة إقليمياً", "معتمدة محلياً", "سرعة التحكيم"]
              },
              {
                name: "المجلات الدولية المرموقة",
                nameEn: "Prestigious International Journals",
                icon: Crown,
                href: "/journals#international",
                color: "#DC2626",
                description: "أبرز المجلات الدولية ذات معامل التأثير العالي في قواعد البيانات العالمية",
                features: ["Scopus", "Web of Science", "معامل تأثير عالي", "انتشار دولي"]
              }
            ].map((item, index) => (
              <motion.div
                key={item.name}
                  ...
                  <CardContent className="p-6 relative z-10">
                    <div className="text-center space-y-4">
                        ...
                        <div className="space-y-2">
                          ...
                          {item.features.length > 2 && (
                            <div className="flex justify-center">
                              <Badge variant="outline" className="text-xs px-2 py-1 bg-gray-50/50">
                                +{item.features.length - 2} مميزة أخرى
                              </Badge>
                            </div>
                          )}
                        </div>
                      ...
                      >
                        ...
                        >
                          <Link to={item.href} className="flex items-center justify-center gap-2 relative z-10">
