...
import { PenTool, BookOpen, FileText, GraduationCap, Users, Clock, Award, Zap } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background" dir="rtl">
        ...
        <div className="container relative z-10 mx-auto px-4">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-primary via-accent to-primary bg-clip-text text-transparent">
              كتابة أكاديمية متميزة
            </h1>
            
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
              نقدم خدمات الكتابة الأكاديمية المتخصصة بأعلى المعايير العلمية والمنهجية
            </p>
      ...
      <section className="py-16 relative overflow-hidden">
        ...
        <div className="container relative z-10 mx-auto px-4 text-center">
          ...
          >
            <h2 className="text-4xl font-bold mb-6">ابدأ مشروعك الأكاديمي</h2>
            <p className="text-xl text-muted-foreground mb-8">
              احصل على كتابة أكاديمية متميزة تلبي أعلى المعايير العلمية
            </p>
            <Button 
              size="lg" 
